...
\begin{equation}
    ...
    x(0) + \omega
\end{equation}
See that the $\underline{d}$ vector factors in both how the initial conditions propagate through the system and how any additional noise $\omega$ play a role. Also note that in the ILC process we do not try to control $y\left(0\right)$ or even model it. We cannot control initial conditions and therefore do not worry about them.
